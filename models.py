...
class NGO(db.Model):
    ...
    tasks = db.relationship('Task', backref='ngo', lazy=True, cascade='all, delete-orphan')
...
class User(db.Model):
    ...
    signups = db.relationship('Signup', backref='user', lazy=True, cascade='all, delete-orphan')
...
class Task(db.Model):
    ...
    signups = db.relationship('Signup', backref='task', lazy=True, cascade='all, delete-orphan')
